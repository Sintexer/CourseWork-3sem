...
protected:
	...
	std::string path{ "TeachingTests.txt" }; //Путь к файлу с обучающими тестами
...
public:
	...
	bool getAnswers();//Метод получает ответы пользователя из файла с ответами
	bool putAnswers();//Метод заносит ответы пользователя в файл
